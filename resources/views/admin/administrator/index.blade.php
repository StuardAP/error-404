...
@section('title', 'Administrators | Lista ')
...
<div class="card">
        <div class="card-header">
            <a class="btn btn-warning" href="{{route('employee.create')}}">Agregar administrador</a>
        </div>
            ...
            <tbody>
                @foreach ($administrator as $admin)
                    <tr>
                        ...
                        <td width="10px">
                            <a href={{ route('administrator.edit',$admin)}} > <button type="button" class="btn btn-success btn-sm" >Editar</button></a>
                        </td> 
                       
                        <td width="10px"> 
                              <form action="{{route('administrator.destroy',$admin) }}" method="post"  class="eliminar">
                                  @csrf
                                    @method('delete')
