            ...
            <div class="card-body">
                {!! Form::open(['route'=>'clients.store']) !!}
                    <div class="form-group">
                        {!! Form::label('client_dni', 'Nombre') !!}
                        {!! Form::text('client_dni', null, ['class'=>'form-control','placeholder'=>'Ingrese un nombre','onkeypress'=>'return  Vnum(event);']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('client_phone', null, ['class'=>'form-control','placeholder'=>'Ingrese sus apellidos','onkeypress'=>'return  Vnum(event);']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('client_address', 'Telefono') !!}
                        {!! Form::text('client_address', null, ['class'=>'form-control','placeholder'=>'Ingrese sus apellidos','onkeypress'=>'return  Vnum(event);']) !!}
