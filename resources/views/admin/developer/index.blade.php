...
<div class="card">
        <div class="card-header">
            <a class="btn btn-warning" href="{{route('developer.create')}}">Agregar desarrollo</a>
        </div>
            ...
            <tbody>
                @foreach ($developer as $develop)
                    <tr>
                        ...
                        <td width="10px">
                            <a href={{ route('developer.edit',$develop)}} > <button type="button" class="btn btn-success btn-sm" >Editar</button></a>
                        </td> 
                       
                        <td width="10px"> 
                              <form action="{{route('developer.destroy',$develop) }}" method="post"  class="eliminar">
                                  @csrf
                                    @method('delete')
