...
<div class="card">
        <div class="card-header">
            <a class="btn btn-warning" href="{{route('employees.create')}}">Agregar marketer</a>
        </div>
    
    <div class="card-body">
        <table id="marketings_T" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>Id</th>
                    <th>Analysis</th>
            ...
            <tbody>
                @foreach ($marketer as $market)
                    <tr>
                        ...
                        <td width="10px">
                            <a href={{ route('marketers.edit',$market)}} > <button type="button" class="btn btn-success btn-sm" >Editar</button></a>
                        </td> 
                       
                        <td width="10px"> 
                              <form action="{{route('marketers.destroy',$market) }}" method="post"  class="eliminar">
                                  @csrf
                                    @method('delete')
