        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    {!! Form::label('uuid', 'Profesion') !!}
                    {!! Form::select('uuid', $profession, null, ['class'=>'form-control','value'=>$employee_profession]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('employee_profession', null, ['class'=>'form-control','placeholder'=>'Ingrese la profesion del empleado','onkeypress'=>'return  Vtxt(event);']) !!}
