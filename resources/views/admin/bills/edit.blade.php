...
@section('title', 'Sales tickets | Modificar')
...
<div class="card">
    <div class="card-body">
        {!! Form::model($bill,['route'=>['bills.update',$bill],'method'=>'put']) !!}
        ...
        <div class="form-group">
            {!! Form::label('bill_date', 'Fecha de emisión') !!}
            {!! Form::datetime('bill_date',$bill->bill_date, ['class' => 'form-control']) !!}
            @error('bill_date')
                <span class="text-danger">{{$message}}</span>
            @enderror
        </div>
