...
<div class="card">
        ...
        <div class="card-header">
            <a class="btn btn-warning" href="{{route('detail-project.index')}}">DETALLES DE LOS PROYECTOS</a>
        </div>
        ...
        <table id="projects" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                @foreach ($projects as $project)
                    <tr>
                        <td>{{$project->uuid}}</td>
                        <td>{{$project->employees['employee_name']}}</td>
                        <td>{{$project->clients['client_name']}}</td>
                        <td>{{$project->project_comments}}</td>
                        <td>{{$project->project_start}}</td>
                        <td>{{$project->project_final}}</td>
                        <td>{{$project->project_status}}</td>

                        <td width="10px">
                            <a href={{ route('projects.edit',$project) }} > <button type="button" class="btn btn-success btn-sm" >Editar</button></a >
                        </td>

                        <td width="10px">
                              <form action="{{route('projects.destroy',$project) }}" method="post"  class="eliminar">
                                  @csrf
                                    @method('delete')
