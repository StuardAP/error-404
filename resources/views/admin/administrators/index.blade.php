...
<div class="card">
        <div class="card-header">
            <a class="btn btn-warning" href="{{route('employees.create')}}">Agregar empleado</a>
        </div>
    ...
    <div class="card-body">
        <table  id="designs_T" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
            {{-- HACER  PARA LA LISTA  DE ADMINISTRADORES --}}
                @foreach ($employees as $employee)
                        <td>{{$employee->uuid}}</td>
                        <td>{{$employee->employee_dni}}</td>
                        <td>{{$employee->employee_name}}</td>
                        <td>{{$employee->employee_lastname}}</td>
                        <td>{{$employee->employee_phone}}</td>
                        <td>{{$employee->employee_email}}</td>
                        <td>{{$employee->employee_salary}}</td>
                        <td>{{$employee->employee_profession}}</td>
                        <td width="10px">
                            <a href={{ route('employees.edit',$employee)}} > <button type="button" class="btn btn-success btn-sm" >Editar</button></a>
                        </td>

                        <td width="10px">
                              <form action="{{route('employees.destroy',$employee) }}" method="post"  class="eliminar">
                                  @csrf
                                    @method('delete')
